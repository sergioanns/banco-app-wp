...
class WpGetApi_Admin_Options {
	...
	public function option_fields() {
		...
		$option_metabox[] = array(
			...
			'id'         => 'wpgetapi_setup',
			'desc'       => __( 'Add the details of the API(s) you are using. Endpoints will be setup in the next step after saving your API(s).', 'wpgetapi' ),
	...
	public function test_the_endpoint() {
		...
		$data = wpgetapi_endpoint( $api_id, $endpoint_id, array( 'debug' => true ) );
		...
		jQuery(document).ready(function($) {
			...
			$('body').on( 'click', '.wpgetapi-test-area .test-button', function(){//delegated
				...
				jQuery.post(ajaxurl, data, function( response ) {
					...
					console.log( output.endpoint_id );
					...
					jQuery( '.wpgetapi-test-area[data-endpoint="' + output.endpoint_id + '"] .wpgetapi-result' ).html( 
						'<div class="side-notice"><p>Below is a test connection to your endpoint with debug mode enabled.<br>' +
						'This is to check you are communicating with your API correctly.<br>' + 
						'The data can be formatted any way you like on the front end.</p></div>' +
						output.data
					);
		...
		?>
            ...
            <hr>
           	...
           	<div class="box">    
                ...
                <ul>
                	<li><?php esc_html_e( 'The Unique ID can be whatever you like but must contain only lowercase letters and underscores. This is used to identify each endpoint within the plugin.', 'wpgetapi' ); ?></li>
        ...
        ?>
            ...
            <hr>
           	...
           	<div class="box">    
           		<strong><?php esc_html_e( 'Notes', 'wpgetapi' ); ?></strong>     
                <ul>
                	<li><?php esc_html_e( 'The API Name and Unique ID can be whatever you like but must contain only lowercase letters and underscores. These are used to identify each API within the plugin.', 'wpgetapi' ); ?></li>
	...
	public function redirect( $object_id, $updated ) {
		...
		if( $object_id == 'wpgetapi_setup' ) {
			...
			$text = apply_filters( 'wpgetapi_admin_notice_text', __( 'Settings saved.', 'wpgetapi' ), $object_id );
